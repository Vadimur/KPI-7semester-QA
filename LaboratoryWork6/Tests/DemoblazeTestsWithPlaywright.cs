...
using LaboratoryWork6.Helpers;
using LaboratoryWork6.PageObjects;
...
namespace LaboratoryWork6.Tests
{
    public class DemoblazeTestsWithPlaywright
    {
        ...
        */
        ...
        public async Task SignUp_Successful()
        {
            ...
            string login = $"vadym.mulish.{seed}";
            string password = "vadym.mulish";
